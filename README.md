...
| **--upgradable** | Flag used to filter the list to only packages that 1). Have a newer version available, and 2). Can be *upgraded* from the currently installed version. It does not install anything — just lists upgradeable packages
